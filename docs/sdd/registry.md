...
| SPEC-0025 | Playtest onboarding | Accepted | M5 | In-game help and controls reference for first testers. |
| SPEC-0026 | Playtest reset and settings | Accepted | M5 | Intentional reset/mute affordances for repeatable playtests. |
| SPEC-0027 | First tester packaging | Accepted | M5 | Local macOS and iPhone/iPad build handoff guidance. |
